<template>
  <div class="body">
    <el-table :data="tableData" border style="width: 100%" height="640" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="auditResult" label="初审结果" min-width="200">
        <template slot-scope="scope"  >
      ...
      <el-table-column label="操作" min-width="200">
        <template slot-scope="scope">
          ...
          <el-button @click="overruled(scope.row)" type="danger" size="small">驳回</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="page">
